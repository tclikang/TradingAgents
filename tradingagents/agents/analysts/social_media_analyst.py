...
The agent is now ``sentiment_analyst`` and aggregates A-stock domestic news
sources (东方财富, 同花顺, 新浪财经) into a single sentiment report. Import
from ``tradingagents.agents.analysts.sentiment_analyst`` going forward;
